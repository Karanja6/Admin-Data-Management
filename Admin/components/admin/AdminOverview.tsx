...
// ✅ Single, correct interface definition
export interface AdminOverviewProps {
  user: User;           // if used anywhere
  detailed?: boolean;
}

// ✅ Component with correct return type and destructured props
export function AdminOverview({ user, detailed = false }: AdminOverviewProps): JSX.Element {
  const stats = {
          ...
          <CardContent className="p-6">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">KSh {(stats.fundsDisbursed / 1_000_000).toFixed(1)}M</p>
