...
export function SystemSettings({ user, onUserUpdate }: SystemSettingsProps) {
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked: boolean) => handleSettingChange('autoExport', checked)}
              />
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked: boolean) => handleSettingChange('googleDriveEnabled', checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked: boolean) => handleSettingChange('oneDriveEnabled', checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked: boolean) => handleSettingChange('dropboxEnabled', checked)}
              />
            </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked: boolean) => handleSettingChange('webhooksEnabled', checked)}
              />
            </div>
